...
# 编译 gpu
sed -i "/.*CONFIG_MALI.*/d" target/linux/rockchip/rk35xx/config-5.10
echo -e "# CONFIG_MALI400 is not set
...
# CONFIG_MALI_TRACE_POWER_GPU_WORK_PERIOD is not set" >> target/linux/rockchip/rk35xx/config-5.10
